...
- At Associate Level, "multi-attach" feature allows it to attach to more than 1 instance at a time
- Bound to a **specific AZ**
- Free tier includes 30GB of SSD or Magnetic storage per month
...
- **Fast Snapshot restore:** Force full init of snapshot to have no latency on first use, but costly to use
